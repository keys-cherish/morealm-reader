 ...
 *
 * **必须在 [drawScrollParagraphBlockStyles] 之前调用** —— group box 是最外层，per-段 box 是叠在
 * 内部的小装饰；group box 先画作背景，per-段 box 后画在 group box 之上。
 *
 * 几何契约：
 ...
 *    加 paddingBottom。pageTop 同 [drawScrollParagraphBlockStyles]，加在每行 y 上。
 *
